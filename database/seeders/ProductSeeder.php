...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $items = [
            ...
            [
                'id' => 88630131,
                'title' => "images Skincare The Max Stem Cell Facial Cleanser, 4 Fl Oz",
                'meta_title' => "images Skincare The Max Stem Cell Facial Cleanser, 4 Fl Oz",
                'description' => $description,
                'meta_description' => "images Skincare The Max Stem Cell Facial Cleanser, 4 Fl Oz",
                'overview' => $productOverview,
                'selling' => 101,
                'purchased' => 81,
                'offered' => 0,
