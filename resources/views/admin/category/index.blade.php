...
@section('content')
            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="pb-3 pt-1 text-end">
                        <a href="{{ route('category.create') }}" class="btn btn-primary ps-4 pe-4">Create
                            {{ $title }}</a>
                    </div>
                                    ...
                                    @foreach ($categories as $category)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img width="60" height="60" src="{{ asset($category->images) }}" alt=""
                                                    class="me-2">
                                                {{ $category->title }}
                                            </td>
                                            <td>{{ $category->slug }}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="" data-bs-toggle="modal" data-id="{{ $category->id }}"
    ...
    <div id="danger-header-modal" class="modal fade" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <form action="{{ route('category.destroy', 'destroy') }}" method="post">
                @csrf
                @method('delete')
