...
@section('content')
            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="pb-3 pt-1 text-end">
                        <a href="{{ route('collection.create') }}" class="btn btn-primary ps-4 pe-4">Create
                            Collections</a>
                    </div>
                                    ...
                                    @foreach ($collections as $collection)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span class="bg-danger ps-3 pe-3 pt-1 pb-1 rounded text-light">Private</span>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="" data-bs-toggle="modal" data-id="{{ $collection->id }}"
    ...
    <div id="danger-header-modal" class="modal fade" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <form action="{{ route('collection.destroy', 'destroy') }}" method="post">
                @csrf
                @method('delete')
