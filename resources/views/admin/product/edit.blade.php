                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" id="title"
                                        ...
                                        value="{{ $product->title }}" aria-describedby="helpId">
                                    @error('title')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="selling" id="selling"
                                                ...
                                                aria-describedby="helpId" value="{{ $product->selling }}">
                                            @error('selling')
                                                <small id="helpId" class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="offered" id="offered"
                                                ...
                                                aria-describedby="helpId" value="{{ $product->offered }}">
                                            @error('offered')
                                                <small id="helpId" class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-md" name="sub_category_id"
                                                ...
                                                <option selected value="{{ $product->sub_category_id }}">
                                                    {{ $product->sub_category->title }}</option>
                                                @foreach ($sub_categories as $sub_category)
                                                    @if ($sub_category->title !== $product->sub_category->title)
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="overview" id="default-editor" rows="13">{{ $product->overview }}</textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label for="" class="form-label">Description</label>
                                        <textarea class="form-control" name="description" id="default-editor1" rows="13">{{ $product->description }}</textarea>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-md" name="brand_id" id="brand_id">
                                                ...
                                                @foreach ($brands as $brand)
                                                    @if ($brand->title !== $product->brand->title)
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-md" name="tax_rule_id"
                                                id="tax_rule_id">
                                                <option selected value="{{ $product->tax_rule_id }}">
                                                    {{ $product->tax->title }}
                                                </option>
                                                @foreach ($tax_rules as $tax_rule)
                                                    @if ($tax_rule->title !== $product->tax->title)
                                                        <option value="{{ $tax_rule->id }}">
                                                            {{ $tax_rule->title }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-md" name="bundle_deal_id"
                                                id="bundle_deal_id">
                                                <option selected value="{{ $product->bundle_deal_id }}">
                                                    {{ $product->bundle->title }}</option>
                                                @foreach ($bundles as $bundle)
                                                    @if ($bundle->title !== $product->bundle->title)
                                            ...
                                            @foreach ($collections as $collection)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        name="collection_id[]"
                                                        @foreach ($product->collection as $key => $item) 
                                                        {{ $item->id == $collection->id ? 'checked' : '' }} @endforeach>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="video">
                                    <video src="{{ asset($product->video) }}" id="previewImg" controls
                                        class="w-100"></video>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="image w-100 mb-2">
                                    <img src="{{ asset($product->images[0]) }}" alt="" class="w-100 photo"
                                        id="image">
                                </div>
