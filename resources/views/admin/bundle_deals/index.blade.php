...
@section('content')
            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="pb-3 pt-1 text-end">
                        <a href="{{ route('bundle_deals.create') }}" class="btn btn-primary ps-4 pe-4">Create
                            Bundle Deals</a>
                    </div>
                                    ...
                                    @foreach ($bundles as $bundle)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img width="100" src="{{ asset($bundle->images) }}" alt=""
                                                    class="me-2">
                                                {{ $bundle->title }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ route('bundle_deals.edit', $bundle->id) }}">
                                                    <i class='uil uil-pen btn-info btn-sm'></i>
                                                </a>
                                                <a href="" data-bs-toggle="modal" data-id="{{ $bundle->id }}"
    ...
    <div id="danger-header-modal" class="modal fade" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <form action="{{ route('bundle_deals.destroy', 'destroy') }}" method="post">
                @csrf
                @method('delete')
