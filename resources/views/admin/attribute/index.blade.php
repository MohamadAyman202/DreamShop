...
@section('content')
            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="pb-3 pt-1 text-end">
                        <a href="{{ route('attribute.create') }}" class="btn btn-primary ps-4 pe-4">Add
                            Attribute</a>
                    </div>
                                    ...
                                    @foreach ($attributes as $attribute)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="" data-bs-toggle="modal" data-id="{{ $attribute->id }}"
    ...
    <div id="danger-header-modal" class="modal fade" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <form action="{{ route('attribute.destroy', 'destroy') }}" method="post">
                @csrf
                @method('delete')
