...
@section('content')
                                ...
                                <tbody>
                                    ...
                                    @foreach ($sub_categories as $sub_category)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($sub_category->featured == 1)
                                                    <span
                                                        class="bg-success ps-3 pe-3 pt-1 pb-1 rounded text-light">Yes</span>
                                                @else
                                                    <span class="bg-danger ps-3 pe-3 pt-1 pb-1 rounded text-light">No</span>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="" data-bs-toggle="modal" data-id="{{ $sub_category->id }}"
    ...
    <div id="danger-header-modal" class="modal fade" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <form action="{{ route('sub-category.destroy', 'destroy') }}" method="post">
                @csrf
                @method('delete')
