                ...
                <div class="col-sm-6">
                    <div class="card widget-flat">
                        <div class="card-body">
                            ...
                            <h5 class="text-muted fw-normal mt-0" title="Number of Orders">Orders
                            </h5>
                ...
                <div class="col-sm-6">
                    <div class="card widget-flat">
                        <div class="card-body">
                            ...
                            <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Revenue
                            </h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap table-hover mb-0">
                            <tbody>
                                <tr>
                                    <td>
                                        <h5 class="font-14 my-1 fw-normal">ASOS Ridley High Waist
                                        </h5>
